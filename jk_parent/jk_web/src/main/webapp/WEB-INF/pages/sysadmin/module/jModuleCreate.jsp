   ...
   新增模块
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr> 
	            <td class="columnTitle">父模块名：</td>
	            <td class="columnTitle"><s:select list="#moduleList" headerKey="" headerValue="--请选择--" listKey="id" listValue="name" name="parentId">
		          </s:select></td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="belong" value=""/>
	            </td>
