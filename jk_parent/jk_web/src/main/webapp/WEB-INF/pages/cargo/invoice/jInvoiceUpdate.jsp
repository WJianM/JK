    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="createTime" value="${createTime}"
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		<td>
		<c:if test="${o.id==shippId}"><input type="radio" name="shippId" value="${o.id}" checked="checked"/></td></c:if>
		<c:if test="${o.id!=shippId}"><input type="radio" name="shippId" value="${o.id}" /></td></c:if>
