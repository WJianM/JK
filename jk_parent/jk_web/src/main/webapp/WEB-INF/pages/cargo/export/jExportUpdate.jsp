...
<script language="JavaScript">
		...
		$(function(){
			var url="${ctx}/cargo/exportAction_getExportProducts";
			var params={"id":"${id}"};
			$.post(url,params,function(data){
				//遍历json
				$(data).each(function(){
					addTRRecord("mRecordTable",this.id, this.productNo, this.cnumber, clearUndefined(this.grossWeight), clearUndefined(this.netWeight), clearUndefined(this.sizeLength), clearUndefined(this.sizeWidth), clearUndefined(this.sizeHeight), clearUndefined(this.exPrice), clearUndefined(this.tax));
				});
			},"json");
			$("body").mouseover(function(){
		         var v=$("input[size='15']");
		         v.blur(function(){
		        	 var parentId=this.parentNode.parentNode;
		         	   if(this.value!=this.defaultValue){
		         		parentId.getElementsByTagName("input")[2].value = "1";
		         	  }
		         });
		    });
		});
	...
	//优化 
	/*  function setTRUpdate(obj) {
   	   var parentId=obj.parentNode.parentNode;
	...
	function addTRRecord(objId, id, productNo, cnumber, grossWeight, netWeight, sizeLength, sizeWidth, sizeHeight, exPrice, tax) {
		...
		oTD.innerHTML = "<input type=\"text\" name=\"mr_cnumber\" maxLength=\"10\" value=\""+cnumber+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(5);
		oTD.innerHTML = "<input type=\"text\" name=\"mr_grossWeight\" maxLength=\"10\" value=\""+grossWeight+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(6);
		oTD.innerHTML = "<input type=\"text\" name=\"mr_netWeight\" maxLength=\"10\" value=\""+netWeight+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(7);
		oTD.innerHTML = "<input type=\"text\" name=\"mr_sizeLength\" maxLength=\"10\" value=\""+sizeLength+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(8);
		oTD.innerHTML = "<input type=\"text\" name=\"mr_sizeWidth\" maxLength=\"10\" value=\""+sizeWidth+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(9);
		oTD.innerHTML = "<input type=\"text\" name=\"mr_sizeHeight\" maxLength=\"10\" value=\""+sizeHeight+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(10);
		oTD.innerHTML = "<input type=\"text\" name=\"mr_exPrice\" maxLength=\"10\" value=\""+exPrice+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(11);
		oTD.innerHTML = "<input type=\"text\" id=\"qyw\" name=\"mr_tax\" maxLength=\"10\" value=\""+tax+"\" onBlur=\"setTRUpdate(this);\" size=\"15\">";
